pipeline {
    ...
    parameters { 
         string(name: 'tomcat_dev', defaultValue: '54.235.232.246', description: 'Staging Server')
         string(name: 'tomcat_prod', defaultValue: '54.208.23.5', description: 'Production Server')
    } 
