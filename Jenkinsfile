pipeline {
    ...
    parameters { 
         string(name: 'tomcat_dev', defaultValue: '35.172.129.209', description: 'Staging Server')
         string(name: 'tomcat_prod', defaultValue: '35.171.24.204', description: 'Production Server')
    } 
